...
public class Core {
	...
	public static long timeToMillis(String time, String date) {
		LocalDateTime localDateTime = LocalDateTime.parse(time+" "+date, DateTimeFormatter.ofPattern("HH:mm:ss dd/MM/yyyy"));
	 ...
	 */
	public static String central(String s, int size) {
